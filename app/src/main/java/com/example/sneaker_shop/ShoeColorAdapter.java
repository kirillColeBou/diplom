...
public class ShoeColorAdapter extends RecyclerView.Adapter<ShoeColorAdapter.ColorViewHolder> {
    ...
    public ShoeColorAdapter(List<Colors> colors, Context context, OnItemClickListener listener) {
